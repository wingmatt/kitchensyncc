  ...
  return (
    <div className="collapsible-panel">
      <h2 onClick={() => setExpanded(!expanded)}>
        <button aria-expanded={expanded}><IngredientStatus status={props.status} className={props.status} statusLabel={props.statusLabel} /><span>{props.title}</span><svg viewBox="0 0 10 10" focusable="false">
